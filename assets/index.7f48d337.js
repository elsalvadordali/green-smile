 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zA=te.exports,jA=Symbol.for("react.element"),BA=Symbol.for("react.fragment"),HA=Object.prototype.hasOwnProperty,WA=zA.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,KA={key:!0,ref:!0,__self:!0,__source:!0};function Tw(t,e,n){var r,i={},s=null,o=null;n!==void 0&&(s=""+n),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(r in e)HA.call(e,r)&&!KA.hasOwnProperty(r)&&(i[r]=e[r]);if(t&&t.defaultProps)for(r in e=t.defaultProps,e)i[r]===void 0&&(i[r]=e[r]);return{$$typeof:jA,type:t,key:s,ref:o,props:i,_owner:WA.current}}Ol.Fragment=BA;Ol.jsx=Tw;Ol.jsxs=Tw;(function(t){t.exports=Ol})(Pl);const kw=Pl.exports.Fragment,D=Pl.exports.jsx,We=Pl.exports.jsxs;function Cw({errMessage:t}){function e(n){return"\u26A0"+n.replace("auth/","").replace(/-/g," ")}return console.log("err message",t),We(kw,{children:[" ",e(t)]})}const qA=({updateUserId:t,toggleLogin:e})=>{const[n,r]=te.exports.useState(""),[i,s]=te.exports.useState(""),[o,a]=te.exports.useState(null);new Date().getMonth().toString(),new Date().getDate().toString();async function l(u){var h;u.preventDefault();const c=await FA(n,i);(h=c.user)!=null&&h.uid?(localStorage.setItem("userId",c.user.uid),t(c.user.uid)):(console.log("ERROR LOGGING IN",typeof c.code),a(c.code))}return D("div",{children:We("form",{onSubmit:u=>l(u),className:"auth",children:[D("h3",{children:"Login"}),D("label",{htmlFor:"email",className:"email-label",children:"Email"}),D("input",{type:"text",id:"email",onChange:u=>r(u.target.value)}),D("label",{htmlFor:"password",className:"password-label",children:"Password"}),D("input",{type:"password",id:"password",onChange:u=>s(u.target.value)}),D("p",{className:"error",children:o&&D(Cw,{errMessage:o})}),D("button",{className:"link",type:"button",onClick:()=>e(),children:"Register"}),D("button",{type:"submit",children:"Next"})]})})},Nw=({goNextPage:t,updateUserId:e,toggleLogin:n})=>{const[r,i]=te.exports.useState(""),[s,o]=te.exports.useState(""),[a,l]=te.exports.useState(null);async function u(c){var f;c.preventDefault();const h=await bA(r,s);(f=h.user)!=null&&f.uid?(localStorage.setItem("userId",h.user.uid),t("write"),e(h.user.uid)):l(h.code)}return D("div",{children:We("form",{onSubmit:c=>u(c),className:"auth",children:[D("h3",{children:"Register"}),D("label",{htmlFor:"email",className:"email-label",children:"Email"}),D("input",{type:"text",id:"email",onChange:c=>i(c.target.value)}),D("label",{htmlFor:"password",className:"password-label",children:"Password"}),D("input",{type:"password",id:"password",onChange:c=>o(c.target.value)}),D("p",{className:"error",children:a&&D(Cw,{errMessage:a})}),D("button",{className:"link",type:"button",onClick:()=>n(),children:"Login"}),D("button",{type:"submit",children:"Register"})]})})},GA=({goNextPage:t,updateUserId:e})=>{const[n,r]=te.exports.useState(!0);function i(){r(!n)}return We(kw,{children:[We("div",{className:"splash",children:[We("h1",{children:["Happy",D("span",{children:"Garden"})]}),D("p",{children:"Visualize the effect of mindfulness by growing plants"}),D("div",{className:"splash-img",children:D("div",{className:"plant logo"})})]}),n&&D(qA,{goNextPage:t,updateUserId:e,toggleLogin:i}),n==!1&&D(Nw,{goNextPage:t,updateUserId:e,toggleLogin:i})]})};const QA=({promptNumber:t,goNextPage:e})=>{let n={},r=new Date().getDate().toString();n={[r]:{promptNumber:0,entry:""}};let i=JSON.parse(localStorage.getItem("entry"));const[s,o]=te.exports.useState(i||n);localStorage.setItem("entry",JSON.stringify(s));const a=["Today I'm proud of...","I'm thankful for...","I honored myself by...","I grew today by...","Today was a great day because...","Today I smiled because...","I'll never forget today because..."];function l(c){c.preventDefault(),e("select")}function u(c){let h=s[r];h.entry=c;let f={...s,[r]:h};o(f)}return We("form",{onSubmit:c=>l(c),children:[D("h3",{className:"gratitude-prompts",children:a[t]}),D("textarea",{className:"gratitude-entry",value:s[r].entry,onChange:c=>u(c.target.value)}),D("button",{className:"gratitude-button",children:"Give Thanks!"})]})};const YA=({plant:t,updatePlantState:e,selectedPlant:n})=>{let r=new Date().getDate().toString();const i=JSON.parse(localStorage.getItem("entry"));function s(o){e&&(i[r].plant=o,localStorage.setItem("entry",JSON.stringify(i)),e(o))}return We("div",{className:n===t?"selected-plant plant-card":"plant-card",onClick:()=>s(t),children:[D("div",{className:t+"-3 plant"}),D("h4",{children:t})]})},XA=({message:t,yes:e,no:n,plant:r})=>{const i=D("div",{className:r+"-3 plant"})||null;return We("div",{className:"modal",children:[D("h5",{children:t}),i,We("div",{className:"row",children:[D("button",{onClick:()=>e(),children:"Yes"}),D("button",{onClick:()=>n(),children:"No"})]})]})},JA=({goNextPage:t})=>{const e=["corn","carrot","cauliflower","plum","eggplant","tulip","cabbage","wheat","pumpkin","radish","lotus","beet","star fruit","cucumber"],[n,r]=te.exports.useState(""),[i,s]=te.exports.useState(!1);function o(c){r(c)}te.exports.useEffect(()=>{n&&s(!0)},[n]);function a(){t("garden")}function l(){s(!1),r("")}const u=n=="corn"|n=="wheat"?`Are you sure you want to plant ${n}?`:`Are you sure you want to plant a(n) ${n}?`;return We("div",{onClick:()=>s(!1),children:[D("h5",{children:"Select a plant"}),D("div",{className:"grid",children:e.map(c=>D(YA,{plant:c,updatePlantState:o,selectedPlant:n},c+"-card"))}),i&&D(XA,{yes:a,no:l,message:u,plant:n})]})};const Aw=({entry:t,month:e,date:n,closeSee:r})=>{const i=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];console.log(t,n);const s=["You were proud of...","You were thankful for...","You honored yourself by...","You grew by...","It was a great day because...","You smiled because...","You'll never forget this day because..."];return console.log(t),We("div",{className:"see",children:[We("div",{className:"bar",children:[D("h6",{className:"date",children:i[e]+" "+n}),D("button",{className:"close",onClick:()=>r(),children:"\u2A2F"})]}),D("h5",{children:s[t.promptNumber]}),D("div",{className:"padding",children:t.entry})]})};const ZA=({db:t})=>{const e=["January","February","March","April","May","June","July","August","September","October","November","December"],n=new Date().getFullYear().toString(),r=new Date().getDate().toString(),[i,s]=te.exports.useState(new Date().getMonth().toString());let o=new Array(30).fill(!0);const[a,l]=te.exports.useState(!1),[u,c]=te.exports.useState(localStorage.getItem("db")?JSON.parse(localStorage.getItem("db")):null);function h(T){const p={};p[n]={},p[n][i]={},p[n][i][r]=T[r],ku(p,userId),localStorage.setItem("db",JSON.stringify(p)),c(p)}function f(T){const p=JSON.parse(localStorage.getItem("entry"));if(p&&p[r].entry){const d=localStorage.getItem("userId");if(p[r].plot=T,t)if(Object.keys(t)[0]<12){const m={};m[n]=t,m[n][i]||(m[n][i]={}),m[n][i][r]=p,localStorage.setItem("db",JSON.stringify({...t[n]})),ku(m,d)}else t[n][i]||(t[n][i]={}),t[n][i][r]=p[r],ku(t,d),localStorage.setItem("db",JSON.stringify({...t[n]})),c(t);else h(p);localStorage.setItem("entry",null)}}function g(T,p){l(D(Aw,{entry:T[p],month:i,closeSee:y,date:p}))}function y(){l(!1)}function v(){if(u){const T=u[n]?u[n][i]:u[i];return console.log("ENTRY ARRAY",T),o.map((p,d)=>{for(let m in T)if(console.log(m,T[m]),T[m].plot==d){let w=Math.min(3,r-m),I=T[m].plant;return D("div",{className:"soil",onClick:()=>g(u[i],m),children:D("div",{className:I+"-"+w+" plant"})},d+1)}return D("div",{className:"soil",onClick:()=>f(d)},d+1)})}else return o=o.map((T,p)=>D("div",{className:"soil",onClick:()=>f(p)},p+1))}return o=v(),We("div",{children:[a,We("header",{children:[u[i-1]&&D("button",{onClick:()=>s(i-1),children:"<"}),D("h3",{children:e[i]}),u[i+1]&&D("button",{onClick:()=>s(i+1),children:"<"})]}),D("div",{className:"garden",children:o})]})},eD=()=>D("div",{children:"Loading..."});function tD(){const[t,e]=te.exports.useState(null),[n,r]=te.exports.useState(localStorage.getItem("userId")||null),[i,s]=te.exports.useState(new Date().getDate().toString()),[o,a]=te.exports.useState(null),l=new Date().getFullYear(),u=new Date().getMonth(),c=new Date().getDate();te.exports.useEffect(()=>{if(n){async function v(){let T=await VA(n);localStorage.setItem("db",JSON.stringify(T)),a(T)}v()}},[n]),te.exports.useEffect(()=>{e(f())},[o]);function h(){let v=JSON.parse(localStorage.getItem("entry"));return v==null&&n?"write":v==null?"login":v[i]?v[c].plant?"garden":v[c].entry?"select":v?"write":"login":(v=null,localStorage.setItem("entry",null),n?"write":"login")}function f(){if(o)if(o[l]&&o[l][u]&&o[l][u][c]){if(o[l][u][c].plant)return"garden";if(o[l][u][c].entry)return"select"}else if(o[u]&&o[u][c]){if(o[u][c].plant)return"garden";if(o[u][c].entry)return"select"}else return h();return h()}function g(v){r(v)}function y(v){e(v)}return t==="login"?D(GA,{goNextPage:y,updateUserId:g}):t==="register"?D(Nw,{goNextPage:y,updateUserId:g}):t==="write"?D(QA,{goNextPage:y,userId:n,promptNumber:Math.floor(Math.random()*7)}):t==="select"?D(JA,{goNextPage:y}):t==="garden"?D(ZA,{goNextPage:y,db:o}):t==="see"?D(Aw,{goNextPage:y}):D(eD,{})}Cu.createRoot(document.getElementById("root")).render(D(Kw.StrictMode,{children:D(tD,{})}));
